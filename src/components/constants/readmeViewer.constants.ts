...
export const README_VIEWER_CONSTANTS = {
  ...
  testHint:
    'Call port cleanup in setup hooks to avoid flaky EADDRINUSE failures in watch mode:',
  architectureHint:
...
export const README_VIEWER_FEATURES = [
  ...
  },
  {
    ...
    description: 'Supports dry-run, verbose logs, force/no-force behavior, and custom logger hooks.'
  }
] as const;
