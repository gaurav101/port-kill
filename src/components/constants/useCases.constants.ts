...
export const USE_CASES: UseCaseItem[] = [
  ...
  },
  {
    ...
    cliExample: 'npx @gks101/port-kill 4173 9229 --no-force --signal SIGTERM',
    codeExample:
  ...
  },
  {
    ...
    cliExample: 'npx @gks101/port-kill 3000 8080 --dry-run --verbose',
    codeExample:
  ...
  },
  {
    ...
    cliExample: 'npx @gks101/port-kill 3000 4000 5432 --verbose',
    codeExample:
  ...
  },
  {
    ...
    cliExample: 'npx @gks101/port-kill 3000 --dry-run --verbose',
    codeExample:
